...
| `anthropic.claude-3-5-haiku` | `anthropic` | Text, Vision, Document | `tool_use` | — | — | `web_search` (web_search_20250305)<br>`web_fetch` (web_fetch_20250910) |
| `anthropic.claude-3-5-sonnet` | `anthropic` | Text, Vision, Document | `tool_use` | — | — | `web_search` (web_search_20250305)<br>`web_fetch` (web_fetch_20250910) |
| `anthropic.claude-3-7-sonnet` | `anthropic` | Text, Vision, Document | `tool_use` | budget: `low`, `medium`, `high`, `max`, `0`, `1024`, `16000`, `32000`, `off`<br>Example: `anthropic.claude-3-7-sonnet?reasoning=1024` | — | `web_search` (web_search_20250305)<br>`web_fetch` (web_fetch_20250910) |
| `anthropic.claude-3-haiku` | `anthropic` | Text, Vision, Document | `tool_use` | — | — | `web_search` (web_search_20250305)<br>`web_fetch` (web_fetch_20250910) |
| `anthropic.claude-3-opus` | `anthropic` | Text, Vision, Document | `tool_use` | — | — | `web_search` (web_search_20250305)<br>`web_fetch` (web_fetch_20250910) |
| `anthropic.claude-3-sonnet-20240229` | `anthropic` | Text, Vision, Document | `tool_use` | — | — | `web_search` (web_search_20250305)<br>`web_fetch` (web_fetch_20250910) |
| `anthropic.claude-3-sonnet` | `anthropic` | Text, Vision, Document | `tool_use` | — | — | `web_search` (web_search_20250305)<br>`web_fetch` (web_fetch_20250910) |
| `anthropic.claude-haiku-4-5-20251001` | `anthropic` | Text, Vision, Document | `json` (schema) | budget: `low`, `medium`, `high`, `max`, `0`, `1024`, `16000`, `32000`, `off`<br>Example: `anthropic.claude-haiku-4-5-20251001?reasoning=1024` | — | `web_search` (web_search_20250305)<br>`web_fetch` (web_fetch_20250910) |
...
| `claude-opus-4-6` | `anthropic` | Text, Vision, Document | `json` (schema) | effort: `auto`, `low`, `medium`, `high`, `max`, `off`<br>Example: `claude-opus-4-6?reasoning=auto` | — | `web_search` (web_search_20260209)<br>`web_fetch` (web_fetch_20260209)<br>beta: `code-execution-web-tools-2026-02-09` |
| `claude-opus-4-7` | `anthropic` | Text, Vision, Document | `json` (schema) | effort: `auto`, `low`, `medium`, `high`, `xhigh`, `max`, `off`<br>Example: `claude-opus-4-7?reasoning=auto` | — | `web_search` (web_search_20260209)<br>`web_fetch` (web_fetch_20260209)<br>beta: `code-execution-web-tools-2026-02-09` |
...
| `gpt52` | `responses` | Text, Vision, Document | `json` (schema) | effort: `minimal`, `low`, `medium`, `high`<br>Example: `gpt52.medium` | `low`, `medium`, `high`<br>Example: `gpt52?verbosity=low` | — |
...
| `responses.o1-2024-12-17` | `responses` | Text, Vision | `json` (schema) | effort: `minimal`, `low`, `medium`, `high`, `xhigh`<br>Example: `responses.o1-2024-12-17.medium` | — | — |
| `responses.o3-2025-04-16` | `responses` | Text, Vision, Document | `json` (schema) | effort: `low`, `medium`, `high`<br>Example: `responses.o3-2025-04-16.medium` | — | — |
| `responses.o3-mini-2025-01-31` | `responses` | Text | `json` (schema) | effort: `low`, `medium`, `high`<br>Example: `responses.o3-mini-2025-01-31.medium` | — | — |
| `responses.o3-pro` | `responses` | Text | `json` (schema) | — | — | — |
| `responses.o4-mini-2025-04-16` | `responses` | Text, Vision, Document | `json` (schema) | effort: `low`, `medium`, `high`<br>Example: `responses.o4-mini-2025-04-16.medium` | — | — |
