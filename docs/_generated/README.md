...
Includes provider preset tables such as `_generated/model_presets_codexresponses.md`
and curated provider catalog tables such as `_generated/model_catalog_hf.md`.
